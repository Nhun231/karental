...
export default function EditBookingInfor() {
  ...
  //   try {
  //     await dispatch(handleSaveBooking()).unwrap();
  //     const updatedState = store.getState();
  //     const errorsBooking = updatedState.rentCar.errorsBooking;
  //     if (Object.keys(errorsBooking).length === 0) {
  //       if (!infor?.data?.driver === false) {
  //         if (!carData?.data) {
  //           console.error("Dữ liệu xe không tồn tại.");
  //           return;
  //         }
  ...
  //             data: {
  //               ...infor?.data,
  //               driverFullName: carData.data.fullName || "",
  //               driverDob: carData.data.dob || "",
  //               driverEmail: carData.data.email || "",
  //               driverPhoneNumber: carData.data.phoneNumber || "",
  //               driverNationalId: carData.data.nationalId || "",
  //               driverCityProvince: carData.data.cityProvince || "",
  //               driverDrivingLicenseUrl: carData.data.drivingLicenseUrl || "",
  //               driverDistrict: carData.data.district || "",
  //               driverWard: carData.data.ward || "",
  //               driverHouseNumberStreet: carData.data.houseNumberStreet || "",
  //             },
  //           })
  //         );
  //       }
        ...
        <Button
          ...
          onClick={async () => {
            try {
              ...
              if (Object.keys(errorsBooking).length === 0) {
                if (infor?.data?.driver === false) {
                  const carInfo = carData?.data || {}; // Tránh lỗi undefined
