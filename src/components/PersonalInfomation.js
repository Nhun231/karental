...
export default function PersonalInformation({ initialData = {} }) {
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Box sx={{ p: 4, borderRadius: 2 }}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <PersonalDetails formData={formData} handleChange={handleChange} handleDateChange={handleDateChange} handleFileChange={handleFileChange} errorMsg={errorMsg} />
          </Grid>
          <Grid item xs={6} >
            <AddressSelector
              formData={formData}
